...
class account extends CI_Controller {
    ...
    public function registerOwner(){
    	...
    	$oid = $this->accountmodel->signupOwner($post);
    	
    	$this->load->model('barmodel');
    	$this->barmodel->createBar($oid,$post);
    	
    	$_SESSION['ownerinfo'] = array('ownerID'=>$oid,'ownerName'=>$post['ownerName']);
    	session_write_close();
...
//     		setcookie("accountKey", $AccountPassword, time()+3600*24*7);
     ...
     *
     */
    private function hashSalt($password){
